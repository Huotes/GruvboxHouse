...
export const metadata: Metadata = {
  ...
  description:
    "Automações, aplicativos e sistemas web sob encomenda. Orçamento grátis, soluções rápidas que cabem no seu bolso. Transforme sua ideia em realidade digital.",
  keywords: [
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                try {
                  var t = localStorage.getItem('gruvbox-theme');
